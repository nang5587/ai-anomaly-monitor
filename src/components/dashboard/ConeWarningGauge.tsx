...
const maxValue = 100;
const filledSegments = Math.round((progressValue / maxValue) * totalSegments);
...
export default function SegmentedRingGaugePie() {
    return (
        <div className="relative w-64 h-64">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <p className="text-5xl font-bold text-white font-lato">{progressValue}</p>
